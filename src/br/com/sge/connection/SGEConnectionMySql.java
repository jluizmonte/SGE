 ...
 * @author joseluiz
 */
public class SGEConnectionMySql {
    ...
    private String nomeDoBanco = "sge";
    private String usuario = "nsoft";
    private String senha = "Jos3@Luiz";

    public SGEConnectionMySql() {
    }

    public SGEConnectionMySql(String pServidor, String pNomeDoBanco, String pUsuario, String pSenha) {
